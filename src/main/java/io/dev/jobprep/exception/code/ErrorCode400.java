...
public enum ErrorCode400 implements ErrorCode {
    ...
    REFRESH_TOKEN_CACHING_FAILED("E01-JWT-001", "리프레쉬 토큰 캐싱 과정에서 에러가 발생하였습니다."),
    REFRESH_TOKEN_CACHE_DELETION_ERROR("E01-JWT-002", "리프레쉬 토큰 캐시 삭제 과정에서 에러가 발생하였습니다"),
    REFRESH_TOKEN_CACHE_VALIDATION_FAILED("E01-JWT-003", "리프레쉬 토큰 캐시 검증 과정에서 에러가 발생하였습니다."),
