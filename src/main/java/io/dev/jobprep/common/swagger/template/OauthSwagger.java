...
public interface OauthSwagger {
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "토큰 재발급 성공",
                    ...
                    headers = {
                        @Header(name = "Set-Cookie-At", description = "Access 토큰 쿠키 설정 헤더",schema = @Schema(type = "string", example = "Authorization=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIyIiwiYXV0aCI6Ik5PUk1BTCIsImVtYWlsIjoic2VvY2Q...")),
                        @Header(name = "Set-Cookie-Rt", description = "Refresh 토큰 쿠키 설정 헤더", schema = @Schema(type = "string", example = "XRefreshTokens=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIyIiwiZXhwIjoxNzM2NzgzNDk4fQ.EcWwUnuJ2_Csfb5..."))
                    }),
