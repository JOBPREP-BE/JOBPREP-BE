...
@Schema(description = "특정 지원 현황 조회 응답 DTO")
@Getter
public class ApplicationStatusInfoResponse {
    ...
    @Schema(description = "자기소개서", example = "저를 꼭 뽑으셔야 합니다!", implementation = String.class)
    @Nullable
    private final String coverLetter;

    @Builder
    private ApplicationStatusInfoResponse(
        String company,
        String position,
    ...
    public static ApplicationStatusInfoResponse from(ApplicationStatus applicationStatus) {
        return ApplicationStatusInfoResponse.builder()
